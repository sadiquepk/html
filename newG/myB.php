               ...
               <div class="col-md-6 col-sm-6">
                    <div class="home-thumb">
                         <div class="section-title">
                              ...
                              <h1 class="wow fadeInUp" data-wow-delay="0.6s">Hello, I am <strong>Sadique</strong> currently based in Calicut city.</h1>
...
<section id="experience" class="parallax-section">
     <div class="container">
          <div class="row">
               ...
               <div class="col-md-6 col-sm-6">
                    <div class="background-image https://image.freepik.com/free-photo/handshake-business-men-concept_53876-31214.jpg"></div>
               </div>
               ...
               <div class="bg-dark col-md-3 col-sm-6">
                    <div class="contact-thumb">
                         <div class="wow fadeInUp contact-info" data-wow-delay="0.6s">
                              ...
                              <p>KKTOWER,MALAPPURAM,KERALA,INDIA</p>
                         </div>

                         <div class="wow fadeInUp contact-info" data-wow-delay="0.8s">
                              <h3 class="color-white">Contact.</h3>
                              <p><i class="fa fa-phone"></i>+91-9656865698</p>
                              <p><i class="fa fa-envelope-o"></i> <a href="mailto:hello@company.co">ksadiquepktr@gmail.com</a></p>
                              <p><i class="fa fa-globe"></i> <a href="#">nrsoftsolution.com</a></p>
                         </div>
